function constructAlarmAddressSpace (server, addressSpace, eventObjects, done) {
  ...
  const tanks = namespace.addObject({
    browseName: 'Tanks',
  ...
  const oilTankLevel = namespace.addVariable({
  ...
  const oilTankLevelCondition = namespace.instantiateExclusiveLimitAlarm(exclusiveLimitAlarmType, {
    componentOf: tanks,
  ...
  // --------------------------------------------------------------
  const gasTankLevel = namespace.addVariable({
  ...
  const oilTankNumber = namespace.addVariable({
  ...
  const gasTankLevelCondition = namespace.instantiateNonExclusiveLimitAlarm(nonExclusiveLimitAlarmType, {
    componentOf: tanks,
  ...
  const myVariables = namespace.addObject({
